...
public class Hundepension extends JFrame{
    ...
    public Hundepension(){
        ...
        setSize(1700,1500); //Größe des Fensters
        ...
        speichern_button.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                speichern(); //Aufruf der speichern Methode
            }
        });
    ...
    public void initObjekte(){ //Erschaffen von Objekten der Klasse Hunde
        Hund h1 = new Hund("Violet", "Yorkshire Terrier", "Kleiner Hund", 3, "Hündin", true,
                            "nichts/niemanden", "Verträgt keine Eier. ",false, "");
        hundeimhotel.add(h1);
        Hund h2 = new Hund("Milo", "Labradoodle", "Mittlerer Hund", 4, "Rüde", true,
                            "Hunden/Rüden", "Frisst gerne alles mögliche.",false, "");
        hundeimhotel.add(h2);
        Hund h3 = new Hund("Miko", "Beagle", "Kleiner Hund", 19, "Hündin", true,
                            "Nichts", "", false, "");
        hundeimhotel.add(h3);
        Hund h4 = new Hund("Chewbacca", "Neufundländer", "Riesiger Hund", 14, "Rüde", true,
                            "Eimerköpfen", "Guter Gefährte", false, "");
        hundeimhotel.add(h4);
        Hund h5 = new Hund("Hulk", "American Pit Bull Terrier", "Großer Hund", 8, "Rüde", false,
                            "lauten Geräuschen", "Nicht erschrecken, sein Fell ist grün gefärbt.", false,"" );
        hundeimhotel.add(h5);
        Hund h6 = new Hund("Blacky", "Dalmatiner", "Großer Hund", 6, "Hündin", true,
                            "Nichts", "", false, "");
        hundeimhotel.add(h6);
        Hund h7 = new Hund("Loki", "Zwergspitz", "Kleinhund", 11, "Rüde", true,
                            "Nichts", "Ist ein bisschen Hinterlistig.", false, "");
        hundeimhotel.add(h7);
        Hund h8 = new Hund("Jabba", "Mops", "Kleiner Hund", 2, "Rüde", true,
                            "Nichts", "", false, "");
        hundeimhotel.add(h8);
        Hund h9 = new Hund("Sky", "Kuvasz", "Großer Hund", 4, "Hündin", true,
                            "Fremden Menschen", "Muss oft gebürstet werden.",false,"");
        hundeimhotel.add(h9);
    }
    // </editor-fold desc>

    // <editor-fold desc="Speichern">
    public void speichern(){
        // Text den Comboboxen und Textfeldern entnehmen und den Variablen zuweisen
        String hundename = nameHund_textfield.getText();
        String rasse = rasse_combobox.getSelectedItem().toString();
        if (rasse.equals("andere:")){ //falls "andere:" ausgewählt wurde, den Text stattdessen dem Textfield entnehmen
        ...
        }catch (NumberFormatException ex) { //falls es sich nicht in einen Double umwandeln lässt...
            if(alter_textfield.getText().isEmpty()){
                JOptionPane.showMessageDialog(null, "Bitte alles ausfüllen");
                //weil es leer ist -> Fehlermeldung "Bitte alles ausfüllen"
            }else{
                JOptionPane.showMessageDialog(null, "Bitte als Altersangabe nur Zahlen eingeben.");}
            //weil z.B. Buchstaben enthalten sind -> Fehlermeldung
